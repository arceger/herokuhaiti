...
Route::get('/cadastrar', [App\Http\Controllers\CadastrarDepend::class, 'create']); 
Route::post('/cadastrar', [App\Http\Controllers\CadastrarDepend::class, 'store'])->name('cadastrar_dep');
