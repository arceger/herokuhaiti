                      ...
                      <div class="card-header" align="center">{{ __('Pagina Cadastro---Continue seu Cadastro') }}</div>
                       ...
                       <form method="POST" action="{{ route('cadastrar_usr') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" value =" fulano" class="col-md-4 col-form-label text-md-right">{{ __('Nome') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" value = "fulano@hotmail.com"class="col-md-4 col-form-label text-md-right">{{ __('E-Mail') }}</label>
